                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="PDFFlip" id="PDFF"
                                source="{{ asset('pdfs/Lucid Prep - Digital Version [Final book] (1).pdf') }}"
                                backgroundColor="#FFFFFF"
                                viewMode="flipbook"
                                enableDownload="true"
                                enablePrint="true">
                            </div>
                            <!--<iframe src="{{ asset('pdfs/Lucid Prep - Digital Version [Final book] (1).pdf') }}" width="100%" height="500px" style="border: none;"></iframe>-->
